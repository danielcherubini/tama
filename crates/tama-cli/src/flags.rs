...
//!
//! This module provides helper functions for extracting tama-specific flags
...
/// Extract tama-specific flags from command line arguments.
///
...
pub fn extract_tama_flags(args: Vec<String>) -> Result<ExtractedFlags> {

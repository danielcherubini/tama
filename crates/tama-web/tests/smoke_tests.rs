...
//! environment with the tama-web server running.

//! # Smoke Test #35: Install llama.cpp prebuilt CUDA from a fresh registry
//!
//! **Prerequisites:**
//! - tama-web server is running on http://127.0.0.1:8080
...
//!
//! **Steps:**
//! 1. Start tama-web with `TAMA_BOUND_TO_LOOPBACK=false`
...
//! 4. Verify:
//!    - Banner does not appear when `TAMA_BOUND_TO_LOOPBACK=true`

//! Backup manifest types for Tama backup/restore.
...
pub struct BackupManifest {
    ...
    /// Tama version that created this backup
...
impl BackupManifest {
    ...
    pub fn new(tama_version: &str) -> Self {
        Self {
            version: BACKUP_FORMAT_VERSION,
            created_at: chrono::Utc::now().to_rfc3339(),
            tama_version: tama_version.to_string(),
    ...
    /// to reject archives created by incompatible Tama versions.

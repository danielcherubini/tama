...
|------|-------------|---------------------|
| [Models Page Horizontal Layout](2026-04-30-models-page-horizontal-layout.md) | Replace models page vertical card grid with horizontal row layout matching dashboard | 🚧 IN PROGRESS |
